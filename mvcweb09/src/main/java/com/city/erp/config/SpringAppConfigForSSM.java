...
public class SpringAppConfigForSSM {
	...
	//使用C3P0连接池框架
	@Bean("dataSourceWithC3P0")
	public DataSource dataSourceWithC3P0() throws Exception{
		ComboPooledDataSource cpds=new ComboPooledDataSource();
		cpds.setDriverClass("com.mysql.jdbc.Driver");
		cpds.setJdbcUrl("jdbc:mysql://localhost:3306/city_erp?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf8&useSSL=false");
		cpds.setUser("root");
	...
	public SqlSessionFactory createSqlSessionFactory(DataSource ds) throws Exception{
		...
		ssfb.setMapperLocations(resourcePatternResolver.getResources("classpath:com/city/erp/dao/xml/*.xml"));
		...
		//配置Model类的别名扫描包
		ssfb.setTypeAliasesPackage("com.city.erp.model");
