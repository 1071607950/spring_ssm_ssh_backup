              ...
              <div class="box-body">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="qty" class="form-control" id="inputEmail3" autocomplete="off" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="file" class="form-control" name="productPhoto" id="inputEmail3" placeholder="">
                  </div>
                </div>
