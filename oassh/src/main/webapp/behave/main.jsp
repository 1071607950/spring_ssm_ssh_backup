          ...
          <div class="box">
            ...
            <c:forEach var="dm" items="${departmentList}"> 
			  <tr>
			     ...
			     <td><a href="tomodify.do?no=${dm.no }" class="btn btn-default">修改</a> <a href="todelete.do?no=${dm.no }" class="btn btn-default">删除</a> <a href="toview.do?no=${no}" class="btn btn-default">详细</a> </td>
			  </tr>
  			</c:forEach>
