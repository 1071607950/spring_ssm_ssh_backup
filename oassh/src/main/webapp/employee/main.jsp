              ...
              <table id="example2" class="table table-bordered table-hover">
               ...
               <c:forEach items="${emplist}" var="em" varStatus="st">
                <tr>
                  ...
                  <td>
                    <a href="tomodify.do?id=${em.id}" class="btn btn-default">修改</a>
                    <a href="todelete.do?id=${em.id}" class="btn btn-default">删除</a>
                    <a href="toview.do?id=${em.id}" class="btn btn-default">查看</a>
                  </td>
                </tr>
                </c:forEach>
