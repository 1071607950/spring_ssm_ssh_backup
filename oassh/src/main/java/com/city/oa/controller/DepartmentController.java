...
public class DepartmentController {
	...
	public String tomodify(@RequestParam(value="no",required=false,defaultValue="0") int no,Model model) throws Exception{
		DepartmentModel dm=departmentService.getByNo(no); //取得指定的部门对象
