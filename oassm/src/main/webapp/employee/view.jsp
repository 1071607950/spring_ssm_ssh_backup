              ...
              <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <fmt:formatDate value="${em.birthday }"/> 
                  </div>
                  </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <c:if test="${em.photoContentType!=null}">
	                  <c:if test='${em.photoIsImage=="Y"}'>
	                   <img src="showphoto03.mvc?id=${em.id}" width="300" height="260" />
	                  </c:if>
	                  <c:if test='${em.photoIsImage=="N"}'>
	                  <a href="showphoto03.mvc?id=${em.id}">下载</a>
	                  </c:if>
                  </c:if> 
                  <c:if test="${em.photoContentType==null}">
                   	无照片
