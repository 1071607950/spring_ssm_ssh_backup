...
public class SpringConfigForSSH {
	...
	public DataSource dataSourceWithinSping() throws Exception{
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/cityoa?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf8&useSSL=false");
	...
	public DataSource dataSourceWithC3P0() throws Exception{
		...
		cpds.setJdbcUrl("jdbc:mysql://localhost:3306/cityerp?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf8&useSSL=false");
		cpds.setUser("root");
	...
	public DataSource dataSource() throws Exception{
		return new JndiDataSourceLookup().getDataSource("java:comp/env/mysqlcityoa");
	}
	...
	public LocalSessionFactoryBean sessionfactory(DataSource dataSource){
		...
		sessionFactoryBean.setPackagesToScan("com.city.erp.model");
